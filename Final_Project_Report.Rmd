...
```{r}
toDAs.idw <- st_join(torontoDAs.demographics.sf, P.idw.sf, join = st_intersects)

ggplot(toDAs.idw) + geom_sf(aes(fill = P), colour = NA)
...
torontoCTs.w <- nb2listw(torontoDAs.nb)
