...
```{r}
toronto_income.sf <- get_census(dataset='CA21', regions=list(CMA="35535"),
                         vectors=c("median_hh_income"="v_CA21_906"), level='CT', quiet = TRUE, 
                         geo_format = 'sf', labels = 'short')

summary(toronto_income.sf)
ggplot(toronto_income.sf) + geom_sf()
```
```{r}
